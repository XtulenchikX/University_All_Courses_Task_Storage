...
- __*get_currencies*__: получает информацию о всех валютах (Данная функция не может быть вызвана чаще чем 1 раз в секунду, при попытке вызова более 1 раза, выводится сообщение об отказе и возврате результатов прошлого запроса)
